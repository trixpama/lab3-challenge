...
var Page1Page = require('./pages/Page1Page');
// endinject

var menuItems = [
  // inject:menuitems
  { payload: 'home', text: 'My App Title' },
  { payload: 'page1', text: 'Page One' },
  // endinject
];
...
var routes = (
  React.createElement(Route, {name: "app", path: "/", handler: Master}, 
    ...
    React.createElement(Route, {name: "page1", handler: Page1Page}), 
    /* endinject */
...
},{"./pages/HomePage":250,"./pages/Page1Page":251,"material-ui":7,"react":249,"react-router":50,"react-tap-event-plugin":87}],2:[function(require,module,exports){
/*!
...
module.exports = React.createClass({displayName: "exports",
  render: function () {
    return (
      React.createElement("div", {className: "page1-page"}, 
        "Page1"
      )
    );
  }
